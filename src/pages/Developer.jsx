...
const developers = [
  {
    ...
    caption:
      "Architecting the full digital experience of Odyssey 2026 — from system design to pixel-perfect UI.",
  ...
  },
  {
    ...
    caption: "Crafting interfaces that feel alive.",
  ...
  },
  {
    ...
    caption: "Powering the engine under the hood.",
  ...
  },
  {
    ...
    name: "Sneha Kulkarni",
    role: "UI/UX Designer",
    caption: "Designing experiences, not just screens.",
        ...
        >
          ...
          >
            <img
              src={dev.image}
              alt={dev.name}
              className="w-24 h-24 rounded-full border border-purple-500/30"
            />
            ...
            <p className="text-slate-400 text-xs">{dev.caption}</p>
