        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="font-body text-white/40 text-sm leading-relaxed">
              The premier AI & technology college fest. Where innovation meets intelligence.
              March 15–17, 2025.
            </p>
            <div className="mt-4">
          ...
          {/* Quick links */}
          <div>
            <h4 className="font-display text-xs tracking-[0.3em] uppercase text-white/30 mb-5">
              Navigation
            </h4>
            <div className="flex flex-col gap-3">
              {[
                ...
                <Link
                  key={link.path}
                  to={link.path}
                  className="font-body text-sm text-white/40 hover:text-neon-blue transition-colors duration-300 w-fit"
                >
                  <span className="font-mono text-neon-blue/40 mr-2">›</span>
                  {link.label}
                </Link>
              ))}
            </div>
            ...
            <div className="flex gap-3 mb-6">
              {socialLinks.map((s) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-9 h-9 flex items-center justify-center border border-white/10 text-white/40 hover:border-neon-blue/40 hover:text-neon-blue transition-all duration-300"
                  aria-label={s.name}
                >
                  {s.icon}
                </motion.a>
